...
!======================================================================================
   subroutine Detailed_ECalc_Inter(E_T, PairList)
      ...
      use SimParameters
      use EnergyTables
      use SimParameters, only : outputEConv, outputEngUnits  
      implicit none
      ...
      write (fl_name, *) "Inter_Energies_LJ.txt"
      open (unit=35, file=trim(adjustl(fl_name)))
      write (35, *) "E_T, E_Ele, E_LJ"
               ...
               do jMol = jMolMin, NPART(jType)
                  ...
                  do iAtom = 1, nAtoms(iType)
                     ...
                     do jAtom = 1, nAtoms(jType)
                        ...
                        write (35, *) E_T, E_Ele, Ele, E_LJ, LJ
      ...
      write (nout, *) "Lennard-Jones Energy:", E_LJ/outputEConv, outputEngUnits  
      write (nout, *) "Eletrostatic Energy:", E_Ele/outputEConv, outputEngUnits   
      write (nout, *) "Total Energy:",  E_Ele + E_LJ
!      write(35,*) "Pair List:"
!      do iMol=1,maxMol
