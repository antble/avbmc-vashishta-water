...
!=============================================================================
   subroutine SwapIn_EnergyCalc_Tersoff(E_Inter, E_Intra, PairList, dETable, rejMove, useInter)
      use Coords
      use CBMC_Variables
      use EnergyCriteria
      use EnergyTables
...
!     has been selected for removal.
   subroutine SwapOut_EnergyCalc_Tersoff(E_Inter, E_Intra, nType, nMol, dETable, useInter)
      use InterEnergy_Tersoff
      use EnergyCriteria
      use EnergyTables
      use Coords
